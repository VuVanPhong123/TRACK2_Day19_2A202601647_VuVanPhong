...
**Source format:** All 8 notebooks live as Jupytext `.py` files (small, easy to review).
...
│   ├── benchmark.py                # canonical NB2 quality + local latency harness
...
| NB3 P99 > 50ms | Notebook warms infrastructure and asserts failure; inspect server-side retrieval overhead before rerunning. |
